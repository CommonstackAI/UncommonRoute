    ...
    def decide(self, votes: list[TierVote]) -> EnsembleResult:
        ...
        if total_weight == 0:
            return EnsembleResult(
                tier_id=None, confidence=0.0, raw_confidence=0.0,
                method="abstain", tier_scores=tier_scores,
            )
        ...
        return EnsembleResult(
            tier_id=safe_tier, confidence=confidence, raw_confidence=raw_confidence,
            method="conservative", tier_scores=normalized,
        )
