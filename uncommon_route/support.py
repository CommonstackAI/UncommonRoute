...
def _stats_summary_payload(stats: RouteStats) -> dict[str, Any]:
    ...
    return {
        ...
        "avg_route_latency_ms": round(summary.avg_route_latency_ms, 6),
        "avg_upstream_elapsed_ms": round(summary.avg_upstream_elapsed_ms, 6),
        "avg_first_token_ms": round(summary.avg_first_token_ms, 6),
