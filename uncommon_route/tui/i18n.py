...
_EN: dict[str, str] = {
    ...
    # CLI wizard (uncommon-route init, non-TUI mode)
    "cli.lang_picker": "Select language / 选择语言",
    "cli.lang.en_label": "English",
    "cli.lang.zh_label": "中文",
    "cli.title": "UncommonRoute setup wizard",
    "cli.intro": "This will help you choose a connection path, configure a client, and optionally start the proxy in background.",
    "cli.section.language": "Language",
    "cli.section.connection": "Connection",
    "cli.section.client": "Client",
    "cli.section.proxy": "Proxy",
    "cli.section.summary": "Summary",
    "cli.upstream.commonstack_hint": "recommended for first-time setup",
    "cli.upstream.local_hint": "for Ollama, gateways, or self-hosted APIs",
    "cli.upstream.byok_hint": "register OpenAI / Anthropic / Google keys directly",
    "cli.upstream.skip_hint": "only configure the client side",
    "cli.upstream.commonstack_url_prompt": "Commonstack upstream URL",
    "cli.upstream.local_url_prompt": "Local/custom upstream URL",
    "cli.upstream.commonstack_key_prompt": "Commonstack API key",
    "cli.upstream.local_key_prompt": "API key (leave blank if not needed)",
    "cli.status.saved_upstream": "Saved primary upstream: {url}",
    "cli.status.saved_api_key": "Saved API key for that upstream",
    "cli.status.no_api_key": "No API key needed for that upstream",
    "cli.status.skip_connection": "Skipping connection setup.",
    "cli.status.cleared_upstream": "Cleared stored primary upstream",
    "cli.status.saved_provider": "Saved provider: {name}",
    "cli.status.run_doctor": "Run `uncommon-route doctor` to validate the key and provider reachability.",
    "cli.status.updated_rc": "Updated {rc}",
    "cli.byok.clear_prompt": "Clear the existing primary upstream and use BYOK-only mode?",
    "cli.byok.add_prompt": "Which provider key do you want to add?",
    "cli.byok.key_prompt": "{name} API key",
    "cli.byok.add_another": "Add another provider?",
    "cli.client.prompt": "Which client do you want to configure?",
    "cli.client.choice_skip": "Skip client setup for now",
    "cli.client.write_rc_prompt": "Write {client} exports to {rc}?",
    "cli.client.exports_header": "Client exports:",
    "cli.proxy.start_prompt": "Start the proxy in background now?",
    "cli.proxy.logs_at": "Logs: {path}",
    "cli.summary.commonstack_saved": "Primary connection saved for Commonstack.",
    "cli.summary.local_saved": "Primary connection saved for a local/custom upstream.",
    "cli.summary.byok_saved": "BYOK providers configured: {names}",
    "cli.summary.no_change": "No connection path was changed in this run.",
    "cli.summary.rc_written": "Client shell exports written to {rc}.",
    "cli.summary.restart_terminal": "Restart your terminal or run `source` on that file before launching the client.",
    "cli.summary.exports_not_written": "Client exports were not written automatically.",
    "cli.summary.client_skipped": "Client setup was skipped.",
    "cli.summary.proxy_running": "Proxy is running at http://localhost:{port}",
    "cli.summary.next_serve": "Next: {cmd}",
    "cli.summary.next_complete_setup": "Next: finish connection setup, then run `uncommon-route doctor`.",
    "cli.summary.use_model_id": 'Use model ID: "uncommon-route/auto"',
...
_ZH: dict[str, str] = {
    ...
    "cli.lang.en_label": "English",
    "cli.lang.zh_label": "中文",
    "cli.title": "UncommonRoute 设置向导",
    "cli.intro": "本向导将帮你选择连接路径、配置客户端，并可选地在后台启动代理。",
    "cli.section.language": "语言",
    "cli.section.connection": "上游连接",
    "cli.section.client": "客户端",
    "cli.section.proxy": "代理",
    "cli.section.summary": "总结",
    "cli.upstream.commonstack_hint": "推荐首次配置使用",
    "cli.upstream.local_hint": "适用于 Ollama、网关或自托管 API",
    "cli.upstream.byok_hint": "直接注册 OpenAI / Anthropic / Google 密钥",
    "cli.upstream.skip_hint": "只配置客户端",
    "cli.upstream.commonstack_url_prompt": "Commonstack 上游 URL",
    "cli.upstream.local_url_prompt": "本地或自定义上游 URL",
    "cli.upstream.commonstack_key_prompt": "Commonstack API key",
    "cli.upstream.local_key_prompt": "API key（本地上游通常无需，可留空）",
    "cli.status.saved_upstream": "已保存主上游：{url}",
    "cli.status.saved_api_key": "已为该上游保存 API key",
    "cli.status.no_api_key": "该上游无需 API key",
    "cli.status.skip_connection": "跳过上游配置。",
    "cli.status.cleared_upstream": "已清除主上游",
    "cli.status.saved_provider": "已保存 provider：{name}",
    "cli.status.run_doctor": "运行 `uncommon-route doctor` 验证密钥和 provider 可达性。",
    "cli.status.updated_rc": "已更新 {rc}",
    "cli.byok.clear_prompt": "清除现有的主上游并切到 BYOK-only 模式？",
    "cli.byok.add_prompt": "要添加哪个 provider 的密钥？",
    "cli.byok.key_prompt": "{name} API key",
    "cli.byok.add_another": "继续添加其他 provider？",
    "cli.client.prompt": "要配置哪个客户端？",
    "cli.client.choice_skip": "暂时跳过客户端配置",
    "cli.client.write_rc_prompt": "把 {client} 的环境变量写入 {rc}？",
    "cli.client.exports_header": "客户端环境变量：",
    "cli.proxy.start_prompt": "现在就在后台启动代理吗？",
    "cli.proxy.logs_at": "日志：{path}",
    "cli.summary.commonstack_saved": "已保存 Commonstack 主连接。",
    "cli.summary.local_saved": "已保存本地/自定义主连接。",
    "cli.summary.byok_saved": "已配置的 BYOK provider：{names}",
    "cli.summary.no_change": "本次运行未修改任何连接路径。",
    "cli.summary.rc_written": "客户端环境变量已写入 {rc}。",
    "cli.summary.restart_terminal": "在启动客户端前，请重启终端或对该文件执行 `source`。",
    "cli.summary.exports_not_written": "未自动写入客户端环境变量。",
    "cli.summary.client_skipped": "已跳过客户端配置。",
    "cli.summary.proxy_running": "代理正在运行：http://localhost:{port}",
    "cli.summary.next_serve": "下一步：{cmd}",
    "cli.summary.next_complete_setup": "下一步：完成上游连接配置，然后运行 `uncommon-route doctor`。",
    "cli.summary.use_model_id": '在客户端中使用模型 ID："uncommon-route/auto"',
    "cli.cancelled": "已取消设置。",
}
